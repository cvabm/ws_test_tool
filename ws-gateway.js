...
const WS_URL = 'ws://10.110.72.213:8188/gw';
...
function rotateLogFile() {
    ...
    if (currentDate !== date) {
        ...
        currentLogStream.write(`[子协议] venus-protocol\n`);
...
function connect() {
    const { full } = getBeijingTime();
    console.log(`\n[连接] [${full}] 正在连接 ${WS_URL} ，子协议: venus-protocol ...`);
    
    ws = new WebSocket(WS_URL, ['venus-protocol']);
